...
**Goal:** Add an AI concept asset layer to Packging OS so visual-direction image/graphic content can produce traceable draft assets without treating them as production-ready files.
...
**Tech Stack:** Markdown-based Claude Skills, Packging OS templates, existing governance validation scripts.
...
**Files:**
- Modify: `.claude/skills/packging-os/SKILL.md`
- Modify: `.claude/skills/packging-os/references/workflow-map.md`
- Modify: `.claude/skills/packging-os/references/output-routing.md`
- Modify: `CLAUDE.md`
- Modify: `README.md`
...
**Files:**
- Read: `.claude/skills/packging-os-maintainer/scripts/validate-packging-os.sh`

- [ ] Run `sh .claude/skills/packging-os-maintainer/scripts/validate-packging-os.sh`.
