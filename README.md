...
| `.claude/skills/knowledge-synthesizer/scripts/get-knowledge-coverage.ps1`         | Claude Code 批量盘点项目沉淀覆盖率                               |
| `.claude/skills/knowledge-synthesizer/scripts/build-knowledge-review-packet.ps1`  | Claude Code 生成本轮知识整理会话包                               |
| `.claude/skills/knowledge-synthesizer/scripts/start-knowledge-review-session.ps1` | Claude Code 一键启动本轮知识整理会话                             |
